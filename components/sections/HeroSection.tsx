...
const HeroSection = () => {
 ...
 ">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl sm:text-5xl lg:text-6xl text-center font-medium text-neutral-white  mb-4 animate-fade-in-up">
          Insights,Ideas&Innovations
        </h1>
        <p className="text-lg sm:text-xl text-neutral-white text-opacity-40 max-w-2xl mx-auto mb-8 animate-fade-in-up delay-100">
